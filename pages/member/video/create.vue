        ...
        <a-row :gutter="[40,0]">
            ...
            <a-col :span="6">
                ...
                <div class="create-submit">
                    <a-button v-if="createForm.link == null"  size="large" type="primary" block @click="uploadVideo" >点击上传</a-button>
                </div>
                <div class="create-submit">
...
export default {
    ...
    methods:{
        ...
        async postCreate(formData){
            try {
                const res = await this.$axios.post(api.postVideoCreate,formData)
                if (res.code != 1) {
                    this.$message.error(
                        res.message,
                        3
