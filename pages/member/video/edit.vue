        ...
        <a-row :gutter="[40,0]">
            <a-col :span="18">
                <a-form-model ref="createForm" :model="createForm" :rules="createForm.rules">
                    ...
                    <a-form-model-item v-if="createForm.link != null" ref="content" prop="content">
                        <div class="video-box">
                            <ul>
                                <li>
            ...
            <a-col :span="6">
                <div class="create-submit">
                    <a-button size="large" v-if="createForm.link == null" block type="primary" @click="uploadVideo" >上传视频</a-button>
                </div>
                <div class="create-submit">
