...
export default {
    ...
    methods: {
        ...
        create(){
            this.$router.push({ name: "member-resource-create"})
        },
        view(e){
            console.log(e)
            // this.$router.push({ name: "resource-id",params:{id:e}})
        },
        edit(e){
            this.$router.push({ name: "member-resource-edit",
                query:{
                    id:e,
                }
            })
        ...
        async postDelete(formData){
            try {
                ...
                const res = await this.$axios.post(api.postResourceRemove,formData)
                if (res.code != 1) {
                    this.$message.error(
                        res.message,
                        3
